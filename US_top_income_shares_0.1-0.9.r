...
#dev.off()
par(family="AppleGothic")
png(file="US_top_income_share_0.1-0.9.png",width=640,height=640)
plot(P99.9_100~year,data=US.top.income.shares,xlab="연도",ylab="소득점유(%)",ylim=c(0,15),type="p",pch=17)
lines(P99.9_100~year,data=US.top.income.shares)
points(P99_99.9~year,data=US.top.income.shares,pch=17,col="red")
lines(P99_99.9~year,data=US.top.income.shares,col="red")
legend("top",legend=c("99.9-100%:$1,906,047 이상(2012년 기준)","99-99.9%:$393,941-$1,906,047"),pch=17,col=c("black","red"))
title(main="미국 소득 상위 1%의 점유율 분할")
dev.off()
