...
#dev.off()
par(family="AppleGothic")
png(file="US_top_income_share_1-4-5.png",width=640,height=640)
...
legend("top",legend=c("99-100%:$393,941 이상(2012년 기준)","95-99%:$161,438-$393,941","90-95%:$113,820-$161,438"),pch=17,col=c("black","red","blue"))
